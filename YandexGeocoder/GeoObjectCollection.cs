...
namespace Yandex
{
    ...
    public class GeoMetaData
    {
        ...
        public static KindType ParseKind(string kind)
        {
            ...
            {
                case "district":
                    return KindType.district;
                case "house":
                    return KindType.house;
                case "locality":
                    return KindType.locality;
                case "metro":
                    return KindType.metro;
                case "street":
                    return KindType.street;
                default:
                    return KindType.locality; //throw new System.Exception();
            }
        }
